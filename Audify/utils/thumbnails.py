...
import aiofiles
import aiohttp
from config import YOUTUBE_IMG_URL, FAILED
...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("Audify/assets/font2.ttf", 32)
        regular_font = ImageFont.truetype("Audify/assets/font.ttf", 18)
    except OSError:
    ...
    # Icons
    icons_path = "Audify/assets/play_icons.png"
